                ...
                <form action="{{route('product.index')}}" id="form-search" action="GET">
                    <div class="row mb-30">
                        ...
                        <select name="status" class="selectpicker" title="Select Status" data-style="btn-select-tag" style="width: 100%;height: 36px;">
                            ...
                            <option value="1" @if(request()->status == 1) selected @endif>Enabled</option>
                            <option value="2" @if(request()->status == 2) selected @endif>Disabled</option>
                        </select>
                        </div>
                        <div class="col-sm-4">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                @if(!Auth::user()->hasRole('member'))
                                                    <a href="{{route('product.enableProduct',$value->id)}}" class="btn-white btn btn-xs">@if($value->status == 1) Disable @else Enable @endif</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
