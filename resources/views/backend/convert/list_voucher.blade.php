@extends('layouts.backend',['page'=>'convert','active'=>'list_convert_voucher'])

@section('header')
  <h4 class="font-color-purple"><i class="fa fa-exchange"></i> <span>List Convert Voucher</span></h4>
@endsection
...
<div class="col-12">
    ...
    <div class="ibox-home bg-boxshadow">
        <div class="ibox-title mb-20">
            <form action="{{ route('convert.list_voucher') }}" method="get" id="form-search">
            <div class="row">
              <div class="col-lg-4">
                    ...
                    <tbody>
                        @forelse ($data as $value)
                            ...
                            <tr>
                              ...
                              <td class="text-center"><span class="badge badge-success p-1">Success</span></td>
