@extends('layouts.backend',['page'=>'av_explorer','active'=>'block'])

@section('header')
  <h4 class="font-color-purple"><i class="icon_globe-2"></i> <span>Transactions in Block#{{request()->block}}</span></h4>
@endsection
